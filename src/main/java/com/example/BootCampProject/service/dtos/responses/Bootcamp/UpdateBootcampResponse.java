...
public class UpdateBootcampResponse {
    ...
    public UpdateBootcampResponse() {
    }

    public UpdateBootcampResponse(int id, String name, int instructorId, Date startDate, Date endDate, Bootcamp.BootcampState bootcampState) {
        this.id = id;
        this.name = name;
