...
public class UpdateBootcampRequest {
    ...
    public UpdateBootcampRequest() {
    }

    public UpdateBootcampRequest(int id, String name, int instructorId, Date startDate, Date endDate, Bootcamp.BootcampState bootcampState) {
        this.id = id;
        this.name = name;
