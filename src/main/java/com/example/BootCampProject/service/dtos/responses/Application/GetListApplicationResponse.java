...
public class GetListApplicationResponse {
    ...
    public GetListApplicationResponse() {

    }

    public GetListApplicationResponse(int id, int applicantId, int bootcampId, Application.ApplicationState applicationState) {
        this.id = id;
